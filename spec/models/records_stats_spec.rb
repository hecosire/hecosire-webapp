...
describe RecordsStats do
  ...
  describe 'dates_for_timechart' do
    ...
    it "maps recrods to dates_for_time chart format" do
      expect(subject.dates_for_timechart(10000)).to eq "'2001-02-03 04:05','2001-02-03 22:05'"
    end
  ...
  describe 'states_for_timechart' do
    ...
    let(:healthy_record) { OpenStruct.new(health_state_id: 1, created_at: DateTime.new(2001,2,3,4,5,6)  ) }
    let(:coming_down_record) { OpenStruct.new(health_state_id: 2, created_at: DateTime.new(2001,2,3,4,5,6) ) }
    let(:sick_record) { OpenStruct.new(health_state_id: 3, created_at: DateTime.new(2001,2,3,4,5,6) ) }
    let(:recovering_record) { OpenStruct.new(health_state_id: 4, created_at: DateTime.new(2001,2,3,4,5,6) ) }
    ...
    it "maps recrods to states_for_timechart format" do
      expect(subject.states_for_timechart(10000)).to eq "'4','2','1','3'"
    end
  end
